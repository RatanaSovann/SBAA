...
📄 **[Read the walkthrough](docs/)** — a 10–15 minute illustrated tour with a real run, the exported
brief, cost projections and the limitations. Open `docs/sbaa-doc.html` in a browser, or
`docs/sbaa-doc.docx` in Word.
...
docs/                   the walkthrough document (web + Word)
```
